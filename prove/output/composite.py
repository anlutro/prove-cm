class CompositeOutput:
	...
	def state_fncall_start(self, *args, **kwargs):
		self._forward('state_fncall_start', args, kwargs)

	def state_fncall_finish(self, *args, **kwargs):
		self._forward('state_fncall_finish', args, kwargs)
